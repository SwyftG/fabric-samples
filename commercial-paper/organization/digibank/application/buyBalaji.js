...
async function main() {
  ...
  try {
    ...
    const buyResponse = await contract.submitTransaction('buy', 'TokyoBookstore', '00001', 'LEARNING JAPANESE', 'DigiBankBalaji', '4900000');

    // process response
    console.log('Process buy transaction response.');

    let book = DigitBook.fromBuffer(buyResponse);

    console.log(`${book.owner} success buy the book ${book.bookNumber} ${book.bookName} .`);
