 ...
 * 4. Construct request to return digit issue by TOM
...
async function main() {
  ...
  try {
    ...
    // return commercial paper to Bookstore
    console.log('Submit commercial paper return transaction.');

    const returnResponse = await contract.submitTransaction('return', 'TokyoBookstore', '00001', 'LEARNING JAPANESE', 'DigiBankTom');
...
main().then(() => {
  ...
  console.log('Return program complete.');

}).catch((e) => {

  console.log('Return program exception.');
  console.log(e);
  console.log(e.stack);
  process.exit(-1);
